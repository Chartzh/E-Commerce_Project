...
public class DatabaseConnection {
    ...
    // PERBAIKAN: Ganti `ecommerce_db` menjadi `ecommerce_database`
    ...
    public static void initializeDatabase() {
        ...
        try {
            ...
            // Hapus baris DROP TABLE IF EXISTS ini jika Anda tidak ingin data terhapus.
            // ... (baris DROP TABLE yang Anda hapus sebelumnya) ...
            ...
            String createProfileTable = "CREATE TABLE IF NOT EXISTS profile (" +
                                        ...
                                        "postal_code VARCHAR(10) NULL, " + // Perbaikan: backtick pada postal_code
            ...
            // Masukkan dummy user dan produk jika database kosong
            if (countTableRows(conn, "users") == 0) {
                ...
                if (adminRegistered && supervisorRegistered && userRegistered) {
            ...
            if (countTableRows(conn, "products") == 0) {
                User supervisorUser = Authentication.getUserByEmail("rajif@example.com");
    ...
    private static int countTableRows(Connection conn, String tableName) throws SQLException {
        String sql = "SELECT COUNT(*) FROM `" + tableName + "`"; // Gunakan backticks untuk nama tabel
