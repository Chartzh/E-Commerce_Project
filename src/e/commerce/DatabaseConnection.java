...
public class DatabaseConnection {
    ...
    public static void initializeDatabase() {
        ...
        try { //
            ...
            // [Perbaikan]: Tambahkan tabel verifications
            String createVerificationsTable = "CREATE TABLE IF NOT EXISTS verifications (" +
                                              "email VARCHAR(100) PRIMARY KEY, " +
                                              "otp_code VARCHAR(10) NOT NULL, " +
                                              "otp_expires_at TIMESTAMP NOT NULL, " +
                                              "FOREIGN KEY (email) REFERENCES users(email) ON DELETE CASCADE ON UPDATE CASCADE)"; // Foreign key ke users
            ...
            if (countTableRows(conn, "products") == 0) { //
                // [Perbaikan]: Pastikan email ini cocok dengan dummy user yang dimasukkan di atas
